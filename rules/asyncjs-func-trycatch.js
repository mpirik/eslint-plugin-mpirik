...
module.exports = {
  ...
  create(context) {
    ...
    function isWithinAsyncIterator(node) {
      ...
      const hasCallbackDefined = parent.arguments.length > 2 && parent.arguments[parent.arguments.length - 1].type === 'FunctionExpression' && parent.arguments[parent.arguments.length - 2].type === 'FunctionExpression';
